...
difference(){
    rotate([0,0,270]){
        translate([-25.4,25.4-wall_height,base])
            cube([50.8,0.9,9]);
    }
    translate([25.4,25.4-8-3.65,10+base+4])
        cube([7.3,9.5,20],center = true);
    translate([25.4,0,10+base+4])
        cube([5,9.5,20],center = true);
